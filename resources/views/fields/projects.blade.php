...
<head>
    <title>Sanish Maharjan | Projects</title>
    <meta charset="UTF-8" />
    ...
    <meta content="Sanish Maharjan | Projects" />
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('css/new/project.css')}}" />
    <link rel="stylesheet" type="text/css" href="{{asset('css/new/style.css')}}" />
    <link rel="stylesheet" href="{{asset('css/new/cursor.css')}}">
    <link id='favicon' rel="icon" href="{{asset('images/favicon.ico')}}" type="image/ico">
    <!--Favicon-->
...
add 
    ...
    <div class="project-box" style="padding: 20px;">
