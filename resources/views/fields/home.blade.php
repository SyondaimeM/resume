...
<head>
    <title>Sanish Maharjan| Home</title>
    <meta charset="UTF-8">
    ...
    <!-- Favicon -->
    <link id='favicon' rel="shortcut icon" href="{{asset('images/new/favicon.ico')}}" type="image/x-ico">
    <!-- Font awesome icons -->
...
<body class="no-scroll-preload">
    ...
    <center>
        <!-- Home Section -->
        <div class="text col-sm-6" style="margin-top: 140px;">Hi <span class="wave"><img src="{{asset('images/Hand.gif')}}" width="35px"></span>&nbsp;, I'm <span class="header">Sanish Maharjan </span>
            <div class="center">
                <div>
                    <img src="{{url('/images/'. (($user->photo_path)?? 'blank-profile.png'))}}" alt="" class="rounded-circle" height="200" width="200">
                </div>
                <br/>
                ...
                <div>
                    <div class="social-icons">
                        ...
                        <a class="socialicon linkedin" href="https://www.linkedin.com/in/sanis/" target="_blank" rel="author">
                        ...
                        <a class="socialicon instagram" href="https://www.instagram.com/san1sh_p/" target="_blank" rel="author">
                        ...
                        <a class="socialicon github" href="https://github.com/SanishMaharjan1" target="_blank" rel="author">
    ...
    <script src="{{asset('js/new/particle.js')}}"></script>
