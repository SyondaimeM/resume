...
<head>
    <title>Sanish Maharjan | Tech Stack</title>
    <meta charset="UTF-8" />
    ...
    <meta property="og:title" content="Sanish Maharjan | Tech Stack" />
    ...
    <meta name="application-name" content="Sanish Maharjan | Tech Stack" />
    <meta name="apple-mobile-web-app-title" content="Sanish Maharjan | Tech Stack" />
    <meta name="summary"
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('css/new/techstack.css')}}" />
    <link rel="stylesheet" type="text/css" href="{{asset('css/new/style.css')}}" />
    <link rel="stylesheet" href="{{asset('css/new/cursor.css')}}">
    <link id='favicon' rel="icon" href="{{asset('images/new/favicon.png')}}" type="image/png">
    <!--Favicon-->
...
Albert Einstein, Scientist
    ...
    <script src="{{asset('js/new/cursor.js')}}"></script>
    ...
    <script src="{{asset('js/new/techstack.js')}}"></script>
</body>
