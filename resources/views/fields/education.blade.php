...
<head>
    <title>Sanish Maharjan | Education</title>
    <meta charset="UTF-8">
    ...
    <meta name="application-name" content="Sanish Maharjan | Education" />
    <meta name="apple-mobile-web-app-title" content="Sanish Maharjan | Education" />
    ...
    <link rel="stylesheet" href="{{ asset('css/new/hover-min')}}.css">
    <script src="https://code.iconify.design/1/1.0.7/iconify.min.js"></script>
    <link rel="stylesheet" href="{{ asset('css/new/preloader.css')}}">
    <link rel="stylesheet" href="{{ asset('css/new/education.css')}}" />
    ...
    <link id='favicon' rel="shortcut icon" href="{{ asset('images/new/favicon.png')}}" type="image/x-png">
...
<body class="no-scroll-preload">
            ...
            <div class="container-fluid px-3 pt-5">
                ...
                <g id="undraw_Tree_swing_646s 1" clip-path="url(#clip0)">
                    ...
                    <div class="px-md-5 p-3 col-md-6 d-flex flex-column align-items-center justify-content-center animate__animated animate__zoomIn animate__delay-1s">
                        <h2 class="dropdown1 main-heading mb-0 education_head">Educational <span class="edu_background">Background</span></h2>
    ...
    <section class="s2">
        <div class="container-sm  edSection">
            <div class="conatiner text-center mb-5">
                <h1 class="head" data-aos="fade-up" data-aos-delay="300">Formal <span class="edu_background">Education</span></h1>
            </div>
    ...
    <section class="timeline">
        <div class="container">
            ...
            <!-- Dynamic Education Timeline Cards -->
   <div class="timeline-item">
      <div class="timeline-img"></div>

      <div class="timeline-content js--fadeInLeft">
        <div class="timeline-img-header" style="background-image: url('{{ asset('images/education/edTimeline1.png')}}'); background-repeat: no-repeat; background-size: auto;"></div>
        <div class="date date1">2015-2020</div>
        <div>
            <h2 class="timelineHeading">Tribhuvan University</h2>
            <h6>Bachelor of Engineering in Computer Engineering</h6>
            <li>1st in the Annual Football competition 2018</li>
            <li>Participated in Volunteering</li>
            <li>Organized Photo Competition</li>
            <li>Participated in Hult Prize</li>
        </div>
      </div>
   </div> 
    ...
    <div class="timeline-item">
      ...
      <div class="timeline-content timeline-card js--fadeInRight">
        <div>
            <div class="timeline-img-header" style="background-image: url('{{ asset('images/education/edTimeline2.png')}}'); background-repeat: no-repeat; background-size: auto; background-position: center top"></div>
        </div>
        <div class="date date2">2013-2015</div>
        <div class="alignment">
            <h3 class="timelineHeading2">HSEB (Higher Secondary Education Board)</h3>
            <h6>Campion Academy</h6>
            <li>1st in Science batch</li>
            <li>Participated in different intercollege competition</li>
            <li>Secured 2nd in 2011 and 1st in 2012 in Chess competition</li>
            <li>Secured 2nd in football competition in 2011</li>
        </div>
      </div>
    ...
    <div class="timeline-item">
      ...
      <div class="timeline-content js--fadeInLeft">
        <div class="timeline-img-header" style="background-image: url('{{ asset('images/education/edTimeline3.png')}}'); background-repeat: no-repeat; background-size: auto"></div>
        <div class="date date3">1998-2013</div>
        <div class="align-third">
            <h2 class="timelineHeading3">SLC (School Leaving Certificate)</h2>
            <h6>Ujjwal Shishu Niketan Academy</h6>
            <li>Top 5% in school in ranking</li>
            <li>3rd in Poem competition</li>
            <li>2nd in Chess competition</li>
            <li>Participated in Tug of War in Valley Competition</li>
        </div>
      </div>
    </div>
    ...
    <script type="text/javascript" src="{{ asset('js/new/education.js')}}"></script>
</body>
